    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{$activity->actImg}}" alt="Activity Image"></td>
                <td>
                    <a href="/CMS/activities/edit/{{$activity->actID}}">
                        <button type="button" class="btn btn-edit">Edit</button>
                    </a>
                    <form method="POST" action="/CMS/activities/destroy/{{$activity->actID}}" onsubmit="return ConfirmDelete(this)" style="display: inline-block;">
                        @method('DELETE')
                        @csrf
