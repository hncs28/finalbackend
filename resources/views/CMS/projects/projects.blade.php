...
<body>
    ...
    <!-- Page Header -->
    <div class="page-header">Projects List</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{ $row->projectImg }}" alt="{{$row->projectName}}" style="max-width: 100px; height: auto;"></td>
                <td>
                    <a href="/CMS/projects/edit/{{$row->projectID}}">
                        <button type="button" class="btn btn-edit">Edit</button>
                    </a>
                    <form method="POST" action="/CMS/projects/destroy/{{$row->projectID}}" onsubmit="return ConfirmDelete(this)" style="display: inline-block;">
                        @method('DELETE')
                        @csrf
    ...
    <a href="/CMS/projects/create" class="btn-add">+ Add New Project</a>
</body>
@else
<style>
            .message-container {
